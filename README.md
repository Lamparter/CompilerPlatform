...
You can build powerful source generators, analysers, and code fixers using the tools provided by the `Riverside.CompilerPlatform` library.
...
`Riverside.CompilerPlatform` is comprised of four main libraries:

- `Riverside.CompilerPlatform.Analyzers`: Exposes helpers and classes for building diagnostic analysers
